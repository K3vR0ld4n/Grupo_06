...
public class ProjectController implements Initializable {
    ...
    private void deleteMethod(){
        ...
        if (b) {
            ...
            System.out.println(EmojiSectionController.profile.getLibrary().getUserEmoji());
            Resource.deleteFilePath(selectedEmoji.getCurrentEmojiPath());
            Resource.deleteFilePath(getClass().getResource(selectedEmoji.getCurrentEmojiPath().substring(18)).toExternalForm());
